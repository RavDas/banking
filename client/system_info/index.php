		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="" id="name" value="<?php echo $_settings->info('') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">System Short Name</label>
					<input type="text" class="form-control form-control-sm" name="" id="short_name" value="<?php echo  $_settings->info('') ?>">
				</div>
			<div class="form-group">
